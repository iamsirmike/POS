...
<body>
<form action="saveproduct.php" method="post" style="width: 400px !important">
...
<button class="btn btn-success btn-block btn-large" style="width:267px; margin-right: 20px !important;"><i class="icon icon-save icon-large"></i> Save</button>
</div>
</div>
</form>
</body>
