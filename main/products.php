...
<a rel="facebox" href="addproduct.php"><Button type="submit" class="btn btn-info" style="width:230px; height:35px; margin-left:5px;" /><i class="icon-plus-sign icon-large"></i> Add Product</button></a><br><br>
	</div>
	    

<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left; margin-left: 200px !important; width:1100px !important;">
	<thead>
		<tr>
	...
	<tbody>
		...
		?>
			</td>			<td><a rel="facebox" title="Click to edit the product" href="editproduct.php?id=<?php echo $row['product_id']; ?>"><button class="btn btn-warning"><i class="icon-edit"></i> </button> </a><br><br>
