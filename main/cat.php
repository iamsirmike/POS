...
<div class="container-fluid" style="margin-top: 19px !important;">
      <div class="row-fluid">
...
<a rel="facebox" href="addcat.php"><Button type="submit" class="btn btn-info" style="margin-left:10px; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Product</button></a><br><br>
</div>

<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left; margin-left: 220px !important; width:1000px !important;">
	<thead>
		<tr>
