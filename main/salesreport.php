...
<form action="salesreport.php" method="get" style="margin-left:200px;">
<center><strong>From : <input type="text" style="width: 223px; height:35px; color:#222;" name="d1" value="" placeholder="eg: 07/15/19"/> To: <input type="text" style="width: 223px; height:35px; color:#222;" name="d2" value="" placeholder="eg: 07/15/19"/>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left; margin-left: 200px !important; width:1100px !important;">
	<thead>
		<tr>
