...
<div class="container-fluid" style="margin-top: 20px">
	...
	<div class="contentheader">
			...
			<ul class="breadcrumb" style="margin-left: 200px !important;">
...
<a rel="facebox" href="addcustomer.php"><Button type="submit" class="btn btn-info" style="margin-left: 10px; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Customer</button></a><br><br>
</div>
