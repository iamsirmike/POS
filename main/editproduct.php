...
<form action="saveeditproduct.php" method="post" style="width: 400px !important">
...
<span>Generic Name : </span><input type="text" style="width:265px; height:30px;"  name="gen" value="<?php echo $row['category']; ?>" /><br>
...
<div>
<button class="btn btn-success btn-block btn-large" style="width:267px; margin-left: 100px !important;"><i class="icon icon-save icon-large"></i> Save Changes</button>
</div>
</div>
</form>
<?php
